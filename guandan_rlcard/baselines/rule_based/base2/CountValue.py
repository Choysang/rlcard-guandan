        ...
        for i in range(nowType, len(config.cardTypes)):
            ...
            for rank1 in actionList[type]:
                ...
                for card in actionList[type][rank1]:
                    ...
                    #_debug_print(thisHandValue, restValue)
                    if (thisHandValue + restValue > maxValue):
                        ...
                        #_debug_print(maxValue, action, restCards)
                        #_debug_print(thisHandValue + restValue)
                    if (type=='ThreeWithTwo'):
                        break
            nowRank = '2'
...
_debug_print(CountValue().HandCardsValue(cards, 0, '2'))

toc = time.time()
_debug_print(toc-tic)'''
#c=['H4', 'C3', 'D2', 'S4', 'H2']
#_debug_print(CountValue().OnlyPairAndSingleHandValue(c,'2'))
#Strategy.SetBeginning("beginning")
#_debug_print(Strategy.roundStage)
