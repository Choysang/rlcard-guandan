...
#_debug_print(CreateActionList().GetAction('Pair', '2', '2', cards))
#_debug_print(CreateActionList().CreateStraight(cards))
#_debug_print(CreateActionList().GetAction('StraightFlush', 'A', '6',cards, 'S'))
