...
#_debug_print(CompareRank().Larger('Bomb','T',4,{'type':'Bomb','rank':'A','action':['SA', 'HA', 'HA', 'DA']}, 'T'))

#_debug_print(not CompareRank().Larger('Pair', 'A', 'A', {'action': ['S6', 'H6', 'C6', 'C6'], 'type': 'Bomb', 'rank': '6'}, '3'))

#_debug_print(CompareRank().Smaller('ThreeWithTwo','J','T',{'type':'ThreeWithTwo','rank':'J','action':['S4', 'H4', 'SJ', 'SJ', 'CJ']}, '2'))