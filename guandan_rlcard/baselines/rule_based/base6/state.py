...
class State(object):
    ...
    def notify_play(self):
        ...
        """
        # TODO: 选手可自行做出其他处理
        _debug_print("{}号位打出{}， 最大动作为{}号位打出的{}".format(self._curPos, self._curAction, self._greaterPos, self._greaterAction))
    ...
    def act_play(self):
        ...
        _debug_print("当前动作为{}号-动作{}， 最大动作为{}号-动作{}，目前可选动作如下：".format(
